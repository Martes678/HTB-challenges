...
En server.py, script donde se implementa el cómo se cifra una cadena de caracteres, se puede ver varias vulnerabilidades, las cuales son: <br>
...
&emsp;&emsp;Como no hay confusión en el cifrado, conociendo los pasos que se hacen para cifrar, hacer los pasos inversos para descifrar. <br>
